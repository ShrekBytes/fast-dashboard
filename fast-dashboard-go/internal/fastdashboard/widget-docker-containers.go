...
const (
	dockerContainerLabelHide        = "fast-dashboard.hide"
	dockerContainerLabelName        = "fast-dashboard.name"
	dockerContainerLabelURL         = "fast-dashboard.url"
	dockerContainerLabelDescription = "fast-dashboard.description"
	dockerContainerLabelSameTab     = "fast-dashboard.same-tab"
	dockerContainerLabelIcon        = "fast-dashboard.icon"
	dockerContainerLabelID          = "fast-dashboard.id"
	dockerContainerLabelParent      = "fast-dashboard.parent"
	dockerContainerLabelCategory    = "fast-dashboard.category"
)
...
func fetchDockerContainersFromSource(
	...
	for i := range containers {
		...
		for label, value := range overrides {
			container.Labels["fast-dashboard."+label] = value
		}
	}
